$(document).ready(function() {
  ...
  $('.btn-menu').on("mouseenter", function(e) {
    e.preventDefault();
    $(this).find('.flecha_abajo').first().css("visibility", "visible");

  }).on("mouseleave", function(e) {
    e.preventDefault();
    $(this).find('.flecha_abajo').first().css("visibility", "hidden");
  });

  $(window).resize(function() {
    setHeightByChildrenHeight('.autoheight');
  });
  ...
  //funcion para auto ajustar el alto de un contenedor cuando en su interior tiene div positon absolute
  setHeightByChildrenHeight('.autoheight');
